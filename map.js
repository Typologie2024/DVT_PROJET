require([
  ...
  esriConfig.apiK="AAPT3NKHt6i2urmWtqOuugvr9ePwitAnRQZrCK71g0Yic_bgB3VmGkyY78cyNSHCejzjfjfwojmljIJFTkndiF9NgzJhYBYlvX9ZaG37bzdqDU1o6c1Yh1HmgbZoUJZ3x5SlGI_zS74vsr2Ea6RJNYVeleKRsYEjkyqLQgjWJmXUiiAnUSP7gGEYEj_On3xP5H7TCvgpTId-8OJbhWcKHgU3BFhj1TsdTzKg2tmcvt4ME8ziYex9E-SLfsmE6ihRcDy_RhtZJ2LP_pADALrzeCi9Bw.."; 
    ...
    const barragepachalikPopup = new PopupTemplate({
      ...
      const douarspachalikPopup = new PopupTemplate({
        title:"Douars Par Pachaliks",
        content:`
        <ul>
        <li>Nom:{NOM}</li>
        <li>Coordonnées: {Latitude},{Longitude}</li>
        <li>Pachalik: {NOM_PACHAL},{Nom_Pach}</li> 
        <li>Province: {PARENT_PAC}</li>
       </ul>`
       });
      ...
      const barragespachaliklayer = new FeatureLayer({
        url:"https://services.arcgis.com/P9RTK808SG69Phfg/arcgis/rest/services/Barrages/FeatureServer/72",
      ...
      const barragecaidatlayer = new FeatureLayer({
        url:"https://services.arcgis.com/P9RTK808SG69Phfg/arcgis/rest/services/Barrages/FeatureServer/71",
        title:"Barrages par Caidats",
        popupTemplate:barragescaidatPopup,
        renderer:barragecaidatRenderer
         });
         
         const douarspachaliklayer = new FeatureLayer({
          url:"https://services.arcgis.com/P9RTK808SG69Phfg/arcgis/rest/services/DOUARS_DU_MAROC/FeatureServer/8",
          title:"Douars_Pachalik",
          popupTemplate:douarspachalikPopup
         });
      
      const  douarslayer = new FeatureLayer({
        url:"https://services.arcgis.com/P9RTK808SG69Phfg/arcgis/rest/services/DOUARS_DU_MAROC/FeatureServer/7",
        title:"Douars_Caidat",
        popupTemplate:douarscaidatPopup
         });
        const provincialayer = new FeatureLayer({
          url:"https://services.arcgis.com/P9RTK808SG69Phfg/arcgis/rest/services/Infrastructures_Routières/FeatureServer/45",
          title:"Routes Provinciales",
          popupTemplate:provincialPopup,
          renderer: provincialRenderer
        });
        const rregionallayer = new FeatureLayer({
          url:"https://services.arcgis.com/P9RTK808SG69Phfg/arcgis/rest/services/Infrastructures_Routières/FeatureServer/69",
          title:"Routes Régionales",
          popupTemplate:regionalPopup,
          renderer:regionalRenderer
        });
        const rnationallayer = new FeatureLayer({
          url:"https://services.arcgis.com/P9RTK808SG69Phfg/arcgis/rest/services/Infrastructures_Routières/FeatureServer/60",
          title:"Routes Nationales",
        ...
        const autoroutelayer = new FeatureLayer({
          url: "https://services.arcgis.com/P9RTK808SG69Phfg/arcgis/rest/services/Infrastructures_Routières/FeatureServer/51",
          title:"Autoroutes",
          popupTemplate:autoroutePopup,
          renderer: autorouteRenderer
        });
        const caidatslayer = new FeatureLayer({
          url:"https://services.arcgis.com/P9RTK808SG69Phfg/arcgis/rest/services/Découpage_administratif/FeatureServer/1",
          title:"Caidats",
          id:"caidatslayerId",
          popupTemplate:caidatsPopup
        });
        const cercleslayer = new FeatureLayer({
          url:"https://services.arcgis.com/P9RTK808SG69Phfg/arcgis/rest/services/Découpage_administratif/FeatureServer/81",
          title:"Cercles",
          id:"cercleslayerId",
          popupTemplate:cerclesPopup
        });
        const pachalikslayer = new FeatureLayer({
          url:"https://services.arcgis.com/P9RTK808SG69Phfg/arcgis/rest/services/Découpage_administratif/FeatureServer/80",
          title:"Pachaliks",
          id:"pachalikslayerId",
          popupTemplate:pachalikPopup
        });
        const provincelayer = new FeatureLayer({
          url: "https://services.arcgis.com/P9RTK808SG69Phfg/arcgis/rest/services/Découpage_administratif/FeatureServer/11",
          title: "Provinces",
          id:"provincelayerId",
        ...
        const regionslayer = new FeatureLayer({
          url: "https://services.arcgis.com/P9RTK808SG69Phfg/arcgis/rest/services/Découpage_administratif/FeatureServer/3",
          title: "Régions",
          id:"regionslayerId",
        ...
        view.ui.add(searchWidget, {
          ...
          searchWidget.sources.push({
           ...
           searchWidget.sources.push({
            layer: douarspachaliklayer,              // FeatureLayer des Douars
            ...
            exactMatch: false,               
            outFields: ["*"],                // Tous les champs retournés dans les résultats
            name: "Douars_Pachalik",                  // Nom affiché dans les résultats de recherche
          ...
          searchWidget.sources.push({
            ...
            exactMatch: false,               
            outFields: ["*"],                // Tous les champs retournés dans les résultats
            name: "Douars_Caidat",                  // Nom affiché dans les résultats de recherche
            placeholder: "Rechercher un Douar",  // Texte d'aide dans la barre de recherche
            maxResults: 6,                   // Limite des résultats affichés
            maxSuggestions: 6,               // Limite des suggestions automatiques
            suggestionsEnabled: true,        // Suggestions automatiques activées
